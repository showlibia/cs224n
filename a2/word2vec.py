...
def negSamplingLossAndGradient(
    ...
    for k in negSampleWordIndices:
        ...
        loss_neg = -np.log(sigmoid(-z))
        loss += loss_neg

        gradCenterVec += (1 - sigmoid(-z)) * u_k
        gradOutsideVecs[k] += (1 - sigmoid(-z)) * centerWordVec
    ### END YOUR CODE   
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    for outsideWord in outsideWords:
        ...
        currLoss, gradCenter, gradOutside = word2vecLossAndGradient(
